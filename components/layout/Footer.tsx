  ...
  return (
    <footer className="bg-stone-100 border-t py-12 px-4 mt-20">
      <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
          <p className="font-bold text-lg text-stone-900 mb-4">Top Marken</p>
        ...
        <div>
          <p className="font-bold text-lg text-stone-900 mb-4">Wissen</p>
          <ul className="text-sm space-y-2 text-stone-600">
        ...
        <div className="col-span-2">
          <p className="font-bold text-lg text-stone-900 mb-4">Transparenz</p>
